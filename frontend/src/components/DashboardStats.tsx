...
export const DashboardStats: React.FC<DashboardStatsProps> = ({ jobs }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-2xl p-6 flex items-center gap-4 hover:bg-slate-800 transition-colors">
        <div className="bg-blue-500/10 p-3 rounded-xl text-blue-400">
          <Briefcase className="w-8 h-8" />
        </div>
        <div>
          <p className="text-slate-400 text-sm font-medium">Vacantes Totales</p>
      ...
      <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-2xl p-6 flex items-center gap-4 hover:bg-slate-800 transition-colors">
        ...
        <div>
          <p className="text-slate-400 text-sm font-medium">Compañías</p>
          <p className="text-3xl font-bold text-white">{companies}</p>
        </div>
      </div>
      ...
      <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-2xl p-6 flex items-center gap-4 hover:bg-slate-800 transition-colors">
        ...
        <div>
          <p className="text-slate-400 text-sm font-medium">Mejor Score</p>
